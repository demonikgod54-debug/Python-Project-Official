...
STANDING_SURFACE = pygame.transform.scale(pygame.image.load("images/playerr.png"), (48, 64))
JUMPING_SURFACE = pygame.transform.scale(pygame.image.load("images/playert.png"), (48, 64))
